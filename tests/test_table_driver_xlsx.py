...
from table_driver_xlsx import table_driver_xlsx


class MockTest(unittest.TestCase):

    @mock.patch(
        'table_driver_xlsx.table_driver_xlsx.openpyxl.Workbook.active',
    ...
    def test__get_sheet_from_workbook_given_sheet_index(self, mock_worksheets):
        ...
        table_driver_xlsx._get_sheet_from_workbook(wb, sheet_index=0)
